// ==UserScript==
// @name         EDUCATIONAL SECURITY RESEARCH TOOL
...
(function() {
    ...
    // ═══════════════════════════════════════════════════════════
    //  IF YOU’RE WATCHING THE CODE, WELCOME
    // ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════
    //  HERE’S THE INVITE LINK FOR YOU: https://t.me/+45rJ9HGTVNNhZDAx
    // ═══════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    //  IF YOU CAME THIS FAR, WELL YEAH… YOU DESERVE A CONVO
    // ═══════════════════════════════════════════════════════════
        ...
        if (document.body) {
            ...
            const urlObs = new MutationObserver(() => {
                if (location.href !== lastUrl) {
                    ...
                    setTimeout(() => { ben_lastVals = ''; ben_larp(); benSwapFlag(); }, 500);
                }
            });
